...
class App extends Component {
  ...
  next = () => {
    ...
    if (values.year >= 0 && values.month >= 0 && values.day >= 0) {
      ...
      if (age >= 18) {
        alert(
          `Congratulations! You're birthday is ${dobIso} and you are ${age} years old. You can now enter this awesome page!`
        );
      } else if (age < 0) {
        alert(`You will be born at ${dobIso}?`);
      } else {
        alert(
          `I'm so sorry! You're birthday is ${dobIso} and you are just ${age} years old. You can't enter this awesome page :(`
        );
      }
    } else {
